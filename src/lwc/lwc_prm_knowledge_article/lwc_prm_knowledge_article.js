...
import getArtcilesByIdForCurrentUser from '@salesforce/apex/CNT_CSM_CommunityArticleDetail.getArtcilesByIdForCurrentPRMUser';
...
export default class lwc_prm_knowledge_article extends LightningElement {
    labels = {
        Close: CLOSE_LABEL,
        ...
        if (data) {
            ...
            setTimeout(() => {
                if (this.article.Content__c) {
                    this.article.Content__c = this.article.Content__c.replace(/partner\/articles\/(\w|\/)*Knowledge\//gi, 'partner/s/kb?u=');
                    this.article.Content__c = this.article.Content__c.replace(/articles\/(\w|\/)*Knowledge\//gi, 'partner/s/kb?u=');
                    this.article.Content__c = this.article.Content__c.replace(/sfc\/servlet.shepherd/gi, 'partner/sfc/servlet.shepherd');
                ...
                if (this.article.Question__c) {
                    this.article.Question__c = this.article.Question__c.replace(/partner\/articles\/(\w|\/)*Knowledge\//gi, 'partner/s/kb?u=');
                    this.article.Question__c = this.article.Question__c.replace(/articles\/(\w|\/)*Knowledge\//gi, 'partner/s/kb?u=');
                    this.article.Question__c = this.article.Question__c.replace(/sfc\/servlet.shepherd/gi, 'partner/sfc/servlet.shepherd');
                ...
                if (this.article.Answer__c) {
                    this.article.Answer__c = this.article.Answer__c.replace(/partner\/articles\/(\w|\/)*Knowledge\//gi, 'partner/s/kb?u=');
                    this.article.Answer__c = this.article.Answer__c.replace(/articles\/(\w|\/)*Knowledge\//gi, 'partner/s/kb?u=');
                    this.article.Answer__c = this.article.Answer__c.replace(/sfc\/servlet.shepherd/gi, 'partner/sfc/servlet.shepherd');
