...
export default class Lwc_csm_knowledge extends NavigationMixin(LightningElement) {
    labels = {
    ...
    navigateTo(event) {
        ...
        switch (to) {
            case 'Home':
                window.location.href = '/support/s';
                break;
            case 'Products':
                window.location.href = '/support/s/kb';
                break;
            case 'SelectedProduct':
                window.location.href = '/support/s/kb?p=' + selectedProduct;
                break;
            default:
                break;
        }
