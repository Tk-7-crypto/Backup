...
import getUploadedFiles from '@salesforce/apex/CNT_TPA_EnhancedFileRelatedList.getUploadedFiles';
import deleteContentDocument from '@salesforce/apex/CNT_TPA_EnhancedFileRelatedList.deleteContentDocument';
import updateContentDocument from '@salesforce/apex/CNT_TPA_EnhancedFileRelatedList.updateContentDocument';
import isEditDeleteAllowed from '@salesforce/apex/CNT_TPA_EnhancedFileRelatedList.isEditDeleteAllowed';
import isShowUploadButton from '@salesforce/apex/CNT_TPA_EnhancedFileRelatedList.isShowUploadButton';
...
export default class Lwc_tpa_fileRelatedList extends NavigationMixin(LightningElement) {
    @api recordId;
    ...
    get descriptionOptions() {
        return [
            {label: 'TPA Certificate', value: 'TPA Certificate'}
        ];
    }
    ...
    @wire(getUploadedFiles, {recordId: '$recordId'})
            ...
            .then(() => {
                if(this.isActionAllowed) {
                    ...
                    this.dispatchEvent(
                        new ShowToastEvent({
                            title: 'Error',
                            message: 'Edit Record not allowed',
                            variant: 'error'
                        })
                    );
                }
        ...
        handleViewAll(event) {
            ...
            let cmpDef = {
                componentDef: "c:lwc_tpa_fileRelatedList",
                attributes: {
        ...
        openModal() {
            this.description = 'TPA Certificate';
