...
import getKnowledgeArticles from '@salesforce/apex/CNT_CSM_CommunityArticles.getArticlesByCategoryForCurrentUser';
...
export default class Lwc_csm_knowledge_browser extends NavigationMixin(LightningElement) {
    labels = {
