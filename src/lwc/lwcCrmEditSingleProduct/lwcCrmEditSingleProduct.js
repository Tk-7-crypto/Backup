...
import saveOLI from '@salesforce/apex/BNFOpptyListLockedGridMobile.saveOLI';
import getRevisedPrice from '@salesforce/apex/CNT_CRM_Edit_products.getRevisedPrice';
import { ShowToastEvent } from 'lightning/platformShowToastEvent';
export default class LwcCrmEditSingleProduct extends LightningElement {
    @api product;
    validateProduct = {};
    @api bnfrecord;
    isErrorFound = false;
        ...
        saveOLI({bnfRec : this.bnfrecord, oliRec : this.validateProduct})
            .then(result => { 
                ...
                if(result != null){ 
                    ...
                    console.log('--result.success---', JSON.stringify(result.success));
