({
        ...
        if (envelopeId != undefined) {
            ...
            action.setCallback(this, function (response) {
                if (response.getState() == "SUCCESS") {
                    ...
                    helper.getAgreementTeam(component);
    ...
    addToListHandler: function (component, event, helper) {
        ...
        recipientListNew.push(...sortResults1('name', false, recipientList2));
        recipientListNew.push(...sortResults1('name', false, recipientList1));
        component.set("v.recipientList", recipientListNew);
        function sortResults1(prop, asc, list) {
