({
    ...
    render: function(component, helper) {
        ...
        // Dirty fix
        if(value==100){
           var dValue = "M 1 0 A 1 1 0 1 1 1 -2.4492935982947064e-16 L 0 0";
        }

        else{
           var dValue = "M 1 0 A 1 1 0 "+Math.floor(value / 50)+" 1 "+
        ...
        path.setAttributeNS(null, "id", "slds-progress-ring-path-22");
